...
const Aboutdata: datatype[] = [
    {
        ...
        country: "Frontend Engineering",
        paragraph: 'React, Next.js, Tailwind CSS. Accessible, responsive, high-performance UIs.',

    },
    {
        imgSrc: "/assets/provide/heaking.svg",
        country: "Backend & APIs",
        paragraph: 'Node.js, Python, REST/GraphQL. Secure, scalable, well-documented services.',

    },
    {
        imgSrc: "/assets/provide/graphic.svg",
        country: "Full‑stack Development",
        paragraph: 'TypeScript-first apps from database to deploy with CI/CD.',

    },
    {
        imgSrc: "/assets/provide/marketing.svg",
        country: "Cloud & DevOps",
        paragraph: 'Deployments, observability, and performance tuning for growth.',
    },
]
