        ...
        <div className="bg-darkblue -mt-40">
            <div className="mx-auto max-w-2xl pt-48 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                            ...
                            <ul>
                                {product.links.map((link, index) => (
                                    <li key={index} className='mb-5'>
                                        <Link href={link.href} className="text-white text-sm font-normal mb-6 space-links">{link.name}</Link>
                                    </li>
                                ))}
                            </ul>
                        </div>
                    ...
                    <div className='col-span-4 md:col-span-4 lg:col-span-4'>
                        ...
                        <div className="flex gap-2 mt-10">
                            ...
                            <h5 className="text-base font-normal text-offwhite">(561)305-8038</h5>
                        </div>
                        <div className="flex gap-2 mt-10">
                            <Image src={'/assets/footer/email.svg'} alt="email-icon" width={24} height={24} />
                            <h5 className="text-base font-normal text-offwhite">leandro.deassis787@gmail.com</h5>
                        </div>
                    </div>
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-t-bordertop'>
                    <h4 className='text-offwhite text-sm text-center lg:text-start font-normal'>© 2025 Your Web Dev Agency. All rights reserved.</h4>
